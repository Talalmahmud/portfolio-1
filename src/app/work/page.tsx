...
const page = () => {
  return (
    <div className=" w-full">
      <PageWrapper>
        <div className=" flex flex-col xl:flex-row overflow-auto gap-2 py-2 md:py-8 xl:py-20">
          <div className=" flex justify-between flex-col xl:flex-row gap-4 ">
            <div className=" flex flex-col gap-2 w-full xl:w-[575px]">
              <p className=" text-4xl md:text-6xl xl:text-8xl font-extrabold text-slate-300 ">
                01
              </p>
              <p className=" text-[20px] md:text-[36px] xl:text-[48px] text-green-500 font-bold">
                Social Media
              </p>
              ...
              <div className=" w-full border-b-[1px] border-dashed border-slate-600 my-2 md:my-4 xl:my-6"></div>
              <div className=" flex items-center gap-2">
                ...
                <Link
                  ...
                  target="_blank"
                >
                  <div className=" h-[32px] w-[32px] bg-white relative flex justify-center items-center border-[1px] border-green-300 hover:border-green-800 cursor-pointer shadow-md rounded-full p-1 hover:animate-spin delay-350">
                    <Image src={"/earth.svg"} fill alt="" />
                  </div>
                </Link>
              </div>
            </div>
            <div className="  w-full xl:w-[475px] h-[280px] md:h-[380px] xl:h-[400px] relative">
          ...
          <div className=" flex justify-between flex-col xl:flex-row gap-4 ">
            <div className=" flex flex-col gap-2 w-full xl:w-[575px]">
              ...
              <div className=" w-full border-b-[1px] border-dashed border-slate-600 my-2 md:my-6 xl:my-8"></div>
              <div className=" flex items-center gap-2">
                {" "}
                <Link
                  href={"https://github.com/Talalmahmud/social-media.git"}
